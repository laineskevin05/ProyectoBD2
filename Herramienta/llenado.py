...
def llenadoPersonas(numero, cursor):
    try:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla Persona')
...
def llenadoEmpleados(numero, cursor):
    try:
        #with conexion.cursor() as cursor:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla empleado')
...
def llenadoHabitaciones(numero, cursor):
    try:
        #with conexion.cursor() as cursor:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla habitaciones')
...
def llenadoProducto_E_Inventario(numero, cursor):
    try:
        #with conexion.cursor() as cursor:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla Producto_E_Inventario')
...
def llenadoReservas_y_ListaReservas(numero, cursor):
    ...
    try:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla Reservaciones y ListaReservaciones')
...
def llenadoConsumo(numero, cursor):
    try:
        #with conexion.cursor() as cursor:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla Consumo')
...
def llenadoSolicitudes_y_Mantenimientos(numero, cursor):
    ...
    try:
        ...
        print('Se han insertado ' + str(numero) + ' registos en la tabla Solicitudes y Mantenimientos')
...
with conexion.cursor() as cursor:
    llenadoPersonas(30, cursor)
    llenadoEmpleados(30, cursor)
    llenadoHabitaciones(30, cursor)
    llenadoProducto_E_Inventario(100, cursor)
    llenadoReservas_y_ListaReservas(70, cursor)
    llenadoConsumo(40, cursor)
    llenadoSolicitudes_y_Mantenimientos(40, cursor)
